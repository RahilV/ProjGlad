...
const routes: Routes =[
  ...
  { path: 'admin/emiCardList', component: EmiCardListComponent },
  { path: 'admin/emiCardByNo', component: EmiCardByNoComponent },
  { path: 'admin/createEmiCard', component: CreateEmiCardComponent },
